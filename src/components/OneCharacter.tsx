...
<div className='p-10'>
    ...
    <div className='flex justify-center'>
        <div className={tw (' bg-zinc-700 border rounded-md py-10 w-1/2 shadow-xl',
            ...
            <div className='flex justify-end mr-8 mb-4'>
                <HeartButton initialState={isFavourite()} handleClick={(status: boolean)=> handleLike(status)}/>
            </div>
            <div className='text-lg grid grid-cols-1 gap-4 justify-items-center'>
                <img src={data?.image} alt={data?.name}
                className={tw('h-32 w-32 mb-8 rounded-full border-2  shadow-lg justify-self-center',
